...
module SolidLog
  class RetentionJobTest < ActiveSupport::TestCase
    ...
    test "deletes regular logs older than retention_days" do
      ...
      SolidLog::Core::Jobs::RetentionJob.perform_now(retention_days: 30, error_retention_days: 90)
    ...
    test "vacuum parameter triggers database vacuum for SQLite" do
      ...
      assert_nothing_raised do
        SolidLog::Core::Jobs::RetentionJob.perform_now(retention_days: 30, error_retention_days: 90, vacuum: true)
      end
    end
    ...
    test "accepts custom retention_days parameter" do
      ...
      SolidLog::Core::Jobs::RetentionJob.perform_now(retention_days: 60, error_retention_days: 90)
      assert_not_nil Entry.find_by(id: old_entry.id)

      # Run with 40 day retention - should delete
      SolidLog::Core::Jobs::RetentionJob.perform_now(retention_days: 40, error_retention_days: 90)
      assert_nil Entry.find_by(id: old_entry.id)
    end
