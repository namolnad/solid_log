...
module SolidLog
  class IngestionFlowTest < ActionDispatch::IntegrationTest
    ...
    test "correlation tracking flow" do
      ...
      timeline = Entry.correlation_timeline_for_request(request_id)
    ...
    test "retention cleanup flow" do
      # Create old entries
      old_entry = create_entry(created_at: 60.days.ago)
      recent_entry = create_entry(created_at: 1.day.ago)

      # Run retention with 30 day policy
      stats = RetentionService.cleanup(retention_days: 30)
